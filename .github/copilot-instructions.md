...
Never manipulate or style page-shell-owned elements such as `main-window`, `content-grid`, or `widget-card`. Define page layout and appearance only through the page composer payload and keep module CSS scoped to module-owned elements.
